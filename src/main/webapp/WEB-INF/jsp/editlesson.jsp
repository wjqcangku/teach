    ...
    <table width="88%" border="0" class="emp_table" style="width:80%;">
        ...
        <tr>
            ...
            <td width="25%">
                ...
                <input type="text" id="currname" name="currname"   value="${curr.currname} "/>
                <span  id="hid1"  style="color: red"></span>
            </td>
            <td width="8%">关联班级：</td>
            <td width="62%">
                <span style="color: red">*</span>
                <input type="text" id="relationclass" name="relationclass" value="${curr.relationclass} "  />
        ...
        <tr>
            ...
            <td>
                <span style="color: red">*</span>
                <input type="text" id="currno" name="currno"  value="${curr.currno} "/>
                <span id="hid3" style="color: red"></span>
            </td>
            <td>课程简介：</td>
            <td>
                <span style="color: red">*</span>
                <input type="text" id="currprofile" name="currprofile"  value="${curr.currprofile} "/>
