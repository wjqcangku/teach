...
<table border="0" cellspacing="0" cellpadding="0">
 ...
 <thead>
  <tr class="henglan" style="font-weight:bold;">
    ...
    <th width="10%" align="center">所属院系</th>
    <th width="10%" align="center">班级编号</th>
    <th width="10%" align="center">班级总人数</th>
    <th width="10%" align="center">班级简介</th>
   ...
   <c:forEach items="${content }" var="content">
    <tr class="tabtd1">
    <td align="center">${content.scname}</td>
    <td align="center">${content.sccollege}</td>
    <td align="center">${content.scno}</td>
    <td align="center">${content.scpeople}</td>
    <td align="center">${content.scprofile}</td>
    <td align="center">${content.sclastdate}</td>
