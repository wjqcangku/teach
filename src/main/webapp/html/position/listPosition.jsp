...
<table width="100%" border="1" >
  ...
  <c:forEach items="${requestScope.list }" var="z">   
  <tr class="tabtd2">
    <td align="center">${z.b_zname }</td>
...
<table border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td align="right">
    	<span>第1/3页</span>
        <span>
        <a href="ZhiWuServlet?page=${page }">首页</a>&nbsp;&nbsp;
        	<c:if test="${page!=1 }">
        	 <a href="ZhiWuServlet?page=${page-1 }">[上一页]</a>&nbsp;&nbsp;
        	</c:if>
           	<c:if test="${page!=countpage }">
            <a href="ZhiWuServlet?page=${page+1 }">[下一页]</a>&nbsp;&nbsp;
            </c:if>
            <a href="ZhiWuServlet?page=${countpage }">尾页</a>
        </span>
    </td>
  </tr>
</table>
