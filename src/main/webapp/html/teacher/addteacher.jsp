    ...
    <table width="88%" border="0" class="emp_table" style="width:80%;">
        ...
        <tr>
            ...
            <td width="25%">
                ...
                <input type="text" id="tname" name="tname"  placeholder="输入教师姓名" />
                <span  id="hid1"  style="color: red"></span>
            </td>
            <td width="8%">任职课程：</td>
            <td width="62%">
                <span style="color: red">*</span>
                <input type="text" id="tcurriculum" name="tcurriculum" placeholder="输入教师任职课程" />
        ...
        <tr>
            ...
            <td>
                <span style="color: red">*</span>
                <input type="text" id="tage" name="tage" placeholder="输入职龄" />
                <span id="hid3" style="color: red"></span>
            </td>
            <td>编号：</td>
            <td>
                <span style="color: red">*</span>
                <input type="text" id="tno" name="tno" placeholder="输入教师编号" />
        ...
        <tr>
            ...
            <td>
                <span style="color: red">*</span>
                <input type="text" id="title" name="title" placeholder="输入教师职称" />
